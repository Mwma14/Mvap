...
export function MobileBottomNav() {
  ...
  return (
    <>
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-xl border-t border-border overflow-hidden" style={{ paddingBottom: 'max(16px, env(safe-area-inset-bottom, 16px))' }}>
